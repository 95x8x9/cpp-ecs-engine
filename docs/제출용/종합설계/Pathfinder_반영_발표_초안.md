...
### 발표 대본
Backlog에서 변화는 acceptance criteria를 구체적으로 늘린 부분입니다.  
먼저 공간 입력 쪽에서는 import 결과를 단순 도면 불러오기로 두지 않고, Room, Door, Obstruction, Obstacle, Connector 후보를 구분해서 검토할 수 있도록 기준을 추가했습니다.  
