...
def build_office_plan(path: Path) -> None:
    ...
    add_title(msp, "OFFICE SUITE SAMPLE", "Small office floor with lobby, meeting room, open office, and service rooms")
    ...
    add_wall(msp, (3.0, 0.0), (3.0, 9.0))
    add_wall(msp, (9.8, 0.0), (9.8, 9.0))
    add_wall(msp, (3.0, 2.4), (9.8, 2.4))
    add_wall(msp, (9.8, 5.0), (14.0, 5.0))

    add_space(doc, msp, "Lobby", 0.1, 0.1, 2.9, 8.9)
    add_space(doc, msp, "Meeting Room", 3.1, 0.1, 9.7, 2.3)
    add_space(doc, msp, "Open Office", 3.1, 2.5, 9.7, 8.9)
    add_space(doc, msp, "Kitchenette", 9.9, 0.1, 13.9, 4.9)
    add_space(doc, msp, "Storage", 9.9, 5.1, 13.9, 8.9)

    add_door(msp, (0.9, 0.0), (1.8, 0.0), swing_center=(0.9, 0.0), swing_radius=0.9, start_angle=0, end_angle=90, layer="EXIT")
    add_door(msp, (3.0, 4.2), (3.0, 5.1), swing_center=(3.0, 4.2), swing_radius=0.9, start_angle=180, end_angle=270)
    add_door(msp, (9.8, 3.5), (9.8, 4.4), swing_center=(9.8, 3.5), swing_radius=0.9, start_angle=0, end_angle=90)
    add_door(msp, (12.0, 9.0), (12.9, 9.0), swing_center=(12.0, 9.0), swing_radius=0.9, start_angle=180, end_angle=270, layer="EXIT")
